...
وضعیت کلی: **نسخهٔ اصلاحی `v4.7.1` برای سلامت‌سنجی صحیح HTTP/HTTPS آمادهٔ انتشار است. آزمون MySQL در release gate اجرا می‌شود.**
...
- لاگ production ثابت کرد برنامه سالم روی `https://0.0.0.0:443` بالا آمده بود؛ probe اشتباهاً `http://127.0.0.1:443` را صدا می‌زد. نسخهٔ `v4.7.1` scheme داخلی را از تنظیمات TLS تشخیص می‌دهد.
