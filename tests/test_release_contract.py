...
def test_release_version_and_install_rollback_contract():
    ...
    assert version == app_version.group(1) == "5.1.0"
    ...
    assert "marzban update --version v5.1.0" in release_docs
    assert "install --version v5.1.0 --database mysql" in release_docs
    assert "marzban update --version v5.0.0-rc.13" in release_docs
    assert "install --version v5.0.0-rc.13 --database mysql" in release_docs
