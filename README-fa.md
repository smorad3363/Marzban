...
|                                                                                                 مسیر فایل json تنظیمات xray (پیشفرض: `xray_config.json`) |                                                      XRAY_JSON             �_-�G����ƭy�ATES_DIRECTORY                                              |
...
خدمات پشتیبان‌گیری مرزبان از دیتابیس MySQL خروجی می‌گیرد، فایل‌های ضروری را فشرده می‌کند و آن‌ها را به ربات تلگرام مشخص‌شده می‌فرستد. یکی از ویژگی‌های اصلی آن، خودکار بودن است که به شما اجازه می‌دهد پشتیبان‌گیری‌ها را هر ساعت برنامه‌ریزی کنید. اگر فایل بزرگ‌تر از سقف آپلود تلگرام باشد، به چند بخش تقسیم و ارسال می‌شود. همچنین می‌توانید در هر زمان پشتیبان‌گیری فوری انجام دهید.
