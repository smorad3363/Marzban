...
STAGE11_BACKUP_ENABLED = config("STAGE11_BACKUP_ENABLED", default=False, cast=bool)
STAGE11_BACKUP_INTERVAL_MINUTES = config("STAGE11_BACKUP_INTERVAL_MINUTES", default=30, cast=int)
STAGE11_BACKUP_SPOOL = config("STAGE11_BACKUP_SPOOL", default="/var/lib/marzban/backups")
STAGE11_BACKUP_KEY = config("STAGE11_BACKUP_KEY", default="")
STAGE11_TELEGRAM_CHAT_ID = config("STAGE11_TELEGRAM_CHAT_ID", default="")
STAGE11_TELEGRAM_MAX_BYTES = config("STAGE11_TELEGRAM_MAX_BYTES", default=45 * 1024 * 1024, cast=int)
STAGE11_OUTBOX_MAX_ATTEMPTS = config("STAGE11_OUTBOX_MAX_ATTEMPTS", default=6, cast=int)
